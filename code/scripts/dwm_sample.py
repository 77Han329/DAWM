...
def dwm_sample(**deps):
    ...
    obs_save_path = f'/dss/dsshome1/0C/di97zuq/project/DAWM/mb_dataset_2e6/{MBConfig.horizon}/{env}/horizon_{MBConfig.horizon}/RTG_{MBConfig.RTG}/observations.npy'
    act_save_path = f'/dss/dsshome1/0C/di97zuq/project/DAWM/mb_dataset_2e6/{MBConfig.horizon}/{env}/horizon_{MBConfig.horizon}/RTG_{MBConfig.RTG}/actions.npy'
    rewards_save_path = f'/dss/dsshome1/0C/di97zuq/project/DAWM/mb_dataset_2e6/{MBConfig.horizon}/{env}/horizon_{MBConfig.horizon}/RTG_{MBConfig.RTG}/rewards.npy'
