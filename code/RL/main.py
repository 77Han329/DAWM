...
from RL.trainers import TD3BCTrainer
...
def main(cfg):
    ...
    env_spec = rl_utils.get_env_spec(cfg.env)
    ...
    if cfg.model.name == "dt":
        ...
        eval_env = rl_utils.make_eval_env(cfg.env, cfg.seed + 100)
    ...
    if snapshot.exists():
        ...
        payload = rl_utils.load_snapshot(snapshot)
    ...
    while iter_n < cfg.train_iters:
        ...
        rl_utils.save_snapshot(work_dir, payload)
